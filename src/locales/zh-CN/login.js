export default {
  ...
  'app.login.message-invalid-credentials': '账户或密码错误（demo@email.com/123456）',
  ...
  'app.register-result.back-home': '返回登录',
  'app.register-result.view-mailbox': '查看邮箱',
  'validation.email.required': '请输入邮箱地址！',
  'validation.email.wrong-format': '邮箱地址格式错误！',
  'validation.userName.required': '请输入邮箱!',
  'validation.password.required': '请输入密码！',
  'validation.password.twice': '两次输入的密码不匹配!',
  'validation.password.strength.msg': '请至少输入 6 个字符。尝试不同模式更加安全。',
  'validation.password.strength.strong': '强度：强',
  'validation.password.strength.medium': '强度：中【含两种模式】',
  'validation.password.strength.short': '强度：太短还有过于单调',
