export default {
  ...
  'app.login.message-invalid-credentials': 'Invalid email or password（demo@email.com/123456）',
  ...
  'app.register-result.back-home': 'Back to login',
  ...
  'validation.password.strength.msg':
    "Please enter at least 6 characters and use more types of password to be safe.",
  'validation.password.strength.strong': 'Strength: strong',
  'validation.password.strength.medium': 'Strength: medium【Two types】',
  'validation.password.strength.short': 'Strength: too short and too simple',
